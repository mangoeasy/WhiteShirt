...
class Dpdo extends DB
{
    ...
    function query($sql, $method, $data = array())
    {
        ...
        try {
            $return = null;
            $pdo = self::connect();
            $stmt = $pdo->prepare($memkey); //准备好一个语句
    ...
    {
        //return eval('return ' . iconv("gb2312", 'utf-8//IGNORE', var_export($arr, true) . ';'));
		return $arr;
    }
